      ...
      body: Stack(
        children: [Container(
          ...
          decoration: const BoxDecoration(
            //color: Color.fromARGB(34, 123, 65, 194),
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      color: Color.fromARGB(255, 0, 175, 166),
                      ),
                      ),
                  ),
                ),
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    DashCategoria(
                      ...
                      svgimg: "assets/icons/029-clapperboard.svg",
                      press: (){},
                    ),
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          style: TextStyle(
            fontSize: 15,
            color: isActive? Color.fromARGB(255, 241, 180, 12) : Color.fromARGB(255, 0, 33, 54)),
          ),
        ],
      ),
    );
